defmodule BlockChain do
  ...
  def buy(bc, from, buyer, amount) do
    bc = send(bc, from, buyer, amount)
  ...
  def main(args) do
    ...
    bc = buy(bc, coinbase, aditya, 7)
    # IO.puts("\n\n\n")
    # print_blocks(bc, true)
    # IO.puts("\n\n\n")
    bc = buy(bc, coinbase, rachit, 10)
    bc = buy(bc, coinbase, kc, 12)
    # print_blocks(bc, true)
